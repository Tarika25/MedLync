...
import { signup, uploadProfilePhoto, sendSignupOTP, verifySignupOTP } from "@/lib/api";
...
export default function SignupPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!phoneVerified) { toast({ title: "Please verify your phone number", variant: "destructive" }); return; }
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {otpStep && (
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <Input id="otp" value={otpCode} onChange={(e) => setOtpCode(e.target.value)} placeholder="6-digit OTP" maxLength={6} />
