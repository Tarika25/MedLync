...
import { createPrescription, listPrescriptions, getPatients, getHospitalDoctors, addHospitalDoctor, removeHospitalDoctor } from "@/lib/api";
          ...
          <DialogContent className="max-w-lg">
            ...
            {selectedPrescription && (
              <div className="space-y-4 mt-2">
                ...
                {/* Clinical details in detail modal */}
